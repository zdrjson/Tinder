...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    DDTinderNavigaitonController *tinderNavigationController = [[DDTinderNavigaitonController alloc] init];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "zdrzdr.github.com.Tinder" in the application's documents directory.
